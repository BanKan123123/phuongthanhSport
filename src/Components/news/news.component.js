        ...
        <div className="bg-gray-100 py-8">
            <div className="container mx-auto px-4">
                <div className="text-center mb-12">
                    ...
                    <p className="text-gray-600">Stay updated with the latest headlines and articles</p>
                </div>
                    ...
                    {news.map((newItem) => ( // Đổi tên biến từ new thành newItem
                        <div key={newItem.id} className="bg-white shadow-lg rounded-lg overflow-hidden">
                            ...
                            <div className="p-6">
                                ...
                                <Link to={`/home/tin-tuc/${newItem.id}`} className="text-blue-500 hover:underline mt-4 block">Read More</Link>
                            </div>
                        </div>
                    ))}
                </div>
